...
-- CreateIndex
CREATE INDEX "Favourite_boardId_idx" ON "Favourite"("boardId");

-- CreateIndex
CREATE INDEX "Favourite_userId_orgId_idx" ON "Favourite"("userId", "orgId");
...
-- AddForeignKey
ALTER TABLE "Favourite" ADD CONSTRAINT "Favourite_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
